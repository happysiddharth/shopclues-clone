...
public class HomescreenFragment extends Fragment {
    ...
    private void setParentRecyclerView() {
        ...
        HomescreenParentRecyclerViewAdpter parentRecyclerViewAdpter = new HomescreenParentRecyclerViewAdpter(ParentItemList());
    ...
    private List<HomescreenChildernModel> categoriesListGenerator() {
        ...
        HomescreenChildernModel item1 = new HomescreenChildernModel(R.drawable.time_sale,"Free Delivery",24);
        HomescreenChildernModel item2 = new HomescreenChildernModel(R.drawable.men_footwear,"Mens Footwear",24);
        HomescreenChildernModel item3 = new HomescreenChildernModel(R.drawable.mobiles_tabs,"Mobile & Tablets",24);
        HomescreenChildernModel item4 = new HomescreenChildernModel(R.drawable.mens_fashions,"Mens Fashion",24);
        HomescreenChildernModel item5 = new HomescreenChildernModel(R.drawable.kids_fashions,"Kids Store",24);
        HomescreenChildernModel item6 = new HomescreenChildernModel(R.drawable.women_fashion,"Women Store",24);
        HomescreenChildernModel item7 = new HomescreenChildernModel(R.drawable.home,"Home Store",24);
        HomescreenChildernModel item8 = new HomescreenChildernModel(R.drawable.men_watches,"Mens Watch",24);
        HomescreenChildernModel item9 = new HomescreenChildernModel(R.drawable.mobile_accessories,"Kitchen & Dinning",24);
        HomescreenChildernModel item10 = new HomescreenChildernModel(R.drawable.kitchen_diinigs,"Food & Beverages",24);
